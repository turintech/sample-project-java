...
public class App {
    ...
    public static void vector() {
        ...
        System.out.println("------");
        System.out.printf("ModifyVector(%s): %s%n", inputVec,
                DsVector.modifyVector(inputVec));
        System.out.printf("SearchVector(%s, 5): %s%n",
                inputVec, DsVector.searchVector(inputVec, 5));
        System.out.printf("SortVector(%s): %s%n", inputVec,
                DsVector.sortVector(inputVec));
        System.out.printf("ReverseVector(%s): %s%n", inputVec,
                DsVector.reverseVector(inputVec));
        System.out.printf("RotateVector(%s, 3): %s%n", inputVec,
                DsVector.rotateVector(inputVec, 3));
        System.out.printf("MergeVectors(%s, %s): %s%n", inputVec, inputVec2,
    ...
    public static void sort() {
        ...
        System.out.printf("DutchFlagPartition(%s, 5): %s%n",
                initialVec, inputVec1);
        System.out.printf("MaxN(%s, 5): %s%n", initialVec,
                Sort.MaxN(initialVec, 5));
        System.out.println();
    }
