...
public class App {
    ...
    public static void vector() {
        List<Integer> inputVec = new ArrayList<>(GenVector.generateVector(10, 10));
        List<Integer> inputVec2 = new ArrayList<>(GenVector.generateVector(10, 10));
    ...
    public static void sort() {
        List<Integer> initialVec = new ArrayList<>(GenVector.generateVector(20, 10));
